...
const config: Config = {
  ...
  baseUrl: '/stereum-plus-web-docs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'stereum-dev', // Usually your GitHub org/user name.
  projectName: 'stereum-plus-web-docs', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/stereum-dev/stereum-plus-web-docs/tree/main/',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/stereum-dev/stereum-plus-web-docs/tree/main/packages/create-docusaurus/templates/shared/',
        },
        theme: {
